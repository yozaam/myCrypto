...
const PubSub = require('./app/pubsubpubnub');
...
//const pubsub = new PubSub({blockchain, transactionPool, redisUrl: REDIS_URL}); //for redis
...
if(isDevelopment){
    ...
    const generateWalletTransaction = ({wallet, recipient,amount}) => {
        ...
        //console.log('what is happening',transaction)
